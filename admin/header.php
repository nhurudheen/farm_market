            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="customerorder.php">View Customer Orders</a></li>
                            <li><i class="fa fa-table"></i><a href="customerorder.php">Update Customer Orders</a></li>
							
                            <li><i class="fa fa-table"></i><a href="#">View Customer rating</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
