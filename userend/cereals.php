					...
					<div class="store-filter clearfix">
						<div class="pull-left">
							...
							<div class="sort-filter">
								<input type="text" class="input" placeholder="Enter any cereals name">
					...
					<div id="store">
						...
						<div class="row">
							<!-- Product Single -->
													<?php
		require_once "connection.php";
		$select_stmt=$db->prepare("SELECT * FROM products WHERE category='cereals'");	
		$select_stmt->execute();
		while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
		{
		?>
