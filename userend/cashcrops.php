	...
	<div id="breadcrumb">
		<div class="container">
			<ul class="breadcrumb">
				...
				<li class="active">CASHCROPS & OTHERS</li>
			</ul>
		</div>
	</div>
	<div class="section">
					...
					<div class="store-filter clearfix">
						<div class="pull-left">
							...
							<div class="sort-filter">
								<input type="text" class="input" placeholder="Enter any CASHCROPS & OTHERS name">
					...
					<div id="store">
						...
						<div class="row">
							<!-- Product Single -->
													<?php
		require_once "connection.php";
		$select_stmt=$db->prepare("SELECT * FROM products WHERE category='cashcrops&others'");	
		$select_stmt->execute();
		while($row=$select_stmt->fetch(PDO::FETCH_ASSOC))
		{
		?>
