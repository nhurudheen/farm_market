<?php
    ...
    //echo $email;
    $password_from_database_query="select password from user_profile where email='$email'";
    ...
    if($row['password']==$old_password){
        $update_password_query="update user_profile set password='$new_password' where email='$email'";
